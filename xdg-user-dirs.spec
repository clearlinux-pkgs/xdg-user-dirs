...
%prep
%setup -q -n xdg-user-dirs-0.18
cd %{_builddir}/xdg-user-dirs-0.18
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1659371598
...
cp %{_builddir}/xdg-user-dirs-%{version}/COPYING %{buildroot}/usr/share/package-licenses/xdg-user-dirs/dfac199a7539a404407098a2541b9482279f690d
%make_install
